        ...
        <div className="container mx-auto px-6 py-12 flex justify-center animate-fade-in">
            <div className="w-full max-w-md">
                <form onSubmit={handleSubmit} className="bg-white shadow-lg rounded-lg px-8 pt-6 pb-8 mb-4">
                    <h1 className="text-3xl font-serif font-bold text-center mb-6 text-primary">Login</h1>
                    <div className="mb-4">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <button type="button" onClick={() => setView('signup')} className="inline-block align-baseline font-bold text-sm text-accent hover:text-primary transition-colors">
                            Don't have an account?
                        </button>
                    </div>
                     <p className="text-center text-gray-500 text-xs mt-6">
                        For your security, please do not share your password and ensure you log out on shared computers.
                    </p>
                </form>
            </div>
             <style>{`
